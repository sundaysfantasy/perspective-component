...
import org.fakester.common.component.display.SmartViewer;
...
public class RadGatewayHook extends AbstractGatewayModuleHook {
    ...
    public void startup(LicenseState activationState) {
        ...
        if (this.componentRegistry != null) {
            ...
            this.componentRegistry.registerComponent(SmartViewer.DESCRIPTOR);
    ...
    public void shutdown() {
        ...
        if (this.componentRegistry != null) {
            this.componentRegistry.removeComponent(SmartViewer.COMPONENT_ID);
